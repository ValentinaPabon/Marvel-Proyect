...
export default function ListLastEvents() {
  const lastEventsFetch = useFetch(
    `http://gateway.marvel.com/v1/public/events?ts=1&apikey=453e4ced1c12993187c62032ccc1a6f3&hash=31b1157d999ab089756abf297ddf97d3&orderBy=startYear&limit=20`
  );
